...
! function(e) {
  ...
  o.prototype = {
    ...
    , init: function(t) {
      var s = this;
      if (s.options = e.extend(!0, {}, e.fn[i].defaults, s.options, t), s.utils.triggerCallback("BeforeInit", s), s.destroy(!0), s.options.disableOnMobile && s.utils.isMobile()) s.disableOnMobile = !0;
      else {
    ...
    , isInViewport: function() {
      ...
      if (!0 === e.options.forceRenderAbove) e.elements.outerWrapper.addClass(e.classes.above);
        ...
        var t = s.scrollTop()
          ...
          , n = l + e.elements.outerWrapper.outerHeight() + e.itemsHeight <= t + i
          , a = l - e.itemsHeight > t
          , o = !n && a
          , r = !o;
...
$.fn.dataImg = function(e) {
  ...
  function n() {
    a.each(function() {
      var e, a, n = $(this)
        , t = (e = n, (a = $(window).width()) > i.med ? e.data("lrg") : a <= i.med && a > i.sml ? e.data("med") : e.data("sml"));
      null != t && (n.is("img") ? n.attr("src", t) : n.css("background-image", "url(" + t + ")"))
    })
  }
  n(), 1 == i.resize && $(window).resize(function() {
    n()
  })
};
! function(t, e, i, s) {
...
jQuery(document).ready(function() {
  var e = jQuery(".nav-button")
    , a = jQuery(".nav-toggle")
    , t = jQuery(".nav-box")
    , r = jQuery(".nav-wrapper")
    , o = jQuery(".nav-inner-wrap")
    , l = jQuery(".nav-overlay")
    , i = jQuery(".nav-main__link")
    , s = jQuery(".nav-sub__link")
    , n = jQuery(".nav-main__link--arrow")
    , u = jQuery(".nav-sub__link--arrow")
    , d = jQuery(".nav-sub__back")
    , m = jQuery(".second-sub__back");
  jQuery(".header .logo img"), jQuery(".header .logo span"), jQuery(".header .logo p");

  function c() {
    document.onmousewheel = document.onwheel = function() {
      return !0
    }, document.onkeydown = function(e) {
      if (33 <= e.keyCode && e.keyCode <= 40) return !0
    }
  }

  function p() {
    i.unbind("click"), s.unbind("click"), jQuery(".nav-main").css("left", "0%").stop(), jQuery(".nav-sub").css("left", "100%").stop(), jQuery(".second-sub").css("left", "100%").stop(), i.hover(function() {
      jQuery(".nav-main__item").removeClass("active"), jQuery(".nav-main__link").removeClass("active"), jQuery(".nav-sub").removeClass("active"), jQuery(".nav-sub__item").removeClass("active"), jQuery(".nav-sub__link").removeClass("active"), jQuery(".second-sub").removeClass("active");
      var e = jQuery(this);
      if (e.addClass("active"), e.hasClass("nav-main__link--arrow")) {
        var a = e.next(".nav-sub");
        a.addClass("active"), hoveredSubItem = a.find(".nav-sub__item").eq(1), hoveredSubItem.addClass("active").find(".nav-sub__link").addClass("active"), hoveredSubItem.find(".nav-sub__link").next(".second-sub").addClass("active")
      }
      i.hasClass("active") && jQuery(this).parent().addClass("active")
    }), s.hover(function() {
      jQuery(".nav-sub__link").removeClass("active"), jQuery(".second-sub").removeClass("active"), jQuery(this).addClass("active"), jQuery(this).next().addClass("active"), s.parent().removeClass("active"), s.hasClass("active") && jQuery(this).parent().addClass("active")
    })
  }

  function v() {
    i.unbind("mouseenter mouseleave"), s.unbind("mouseenter mouseleave"), d.unbind("hover"), m.unbind("hover"), o.unbind("click"), jQuery(".nav-main__item").removeClass("active"), jQuery(".nav-sub__item").removeClass("active"), jQuery(".nav-main__link").removeClass("active"), jQuery(".nav-sub__link").removeClass("active"), i.on("click", function(e) {
      e.preventDefault()
    }), n.on("click", function(e) {
      e.preventDefault(), jQuery(".nav-main").animate({
        left: "-100%"
      }, 700), jQuery(".nav-main__link").removeClass("active"), jQuery(".nav-sub").removeClass("active"), jQuery(".second-sub").removeClass("active"), jQuery(this).next().addClass("active").animate({
        left: "100%"
      }, 700)
    }), u.on("click", function(e) {
      e.preventDefault(), jQuery(".nav-sub__link").removeClass("active"), jQuery(".second-sub").removeClass("active"), jQuery(this).parent().parent().animate({
        left: "0%"
      }, 700), jQuery(this).next().addClass("active").animate({
        left: "100%"
      }, 700)
    }), d.on("click", function() {
      jQuery(this).parent().animate({
        left: "100%"
      }, 700), jQuery(this).parent().parent().parent().animate({
        left: "0%"
      }, 700)
    }), m.on("click", function() {
      jQuery(this).parent().animate({
  ...
  t.on("click", function() {
    a.hasClass("nav-toggle--closed") ? (a.removeClass("nav-toggle--closed").addClass("nav-toggle--opened"), r.removeClass("nav-wrapper--closed").slideToggle("slow").addClass("nav-wrapper--opened"), e.addClass("active"), l.addClass("active"), document.onmousewheel = document.onwheel = function() {
      return !1
    }, document.onkeydown = function(e) {
      if (33 <= e.keyCode && e.keyCode <= 40) return !1
    }) : (e.removeClass("active"), a.removeClass("nav-toggle--opened").addClass("nav-toggle--closed"), r.removeClass("nav-wrapper--opened").slideToggle("slow").addClass("nav-wrapper--closed"), e.removeClass("active"), l.removeClass("active"), c())
  }), l.on("click", function() {
    e.removeClass("active"), a.removeClass("nav-toggle--opened").addClass("nav-toggle--closed"), r.removeClass("nav-wrapper--opened").slideToggle("slow").addClass("nav-wrapper--closed"), e.removeClass("active"), l.removeClass("active"), c()
  }), 768 < jQuery(window).width() ? (p(), jQuery(".nav-main li a").not().hasClass("nav-main__link--arrow") && jQuery(".nav-main li").on("click", function() {
    var e = jQuery(this).find("a").attr("href");
    window.location.replace(e)
  })) : v(), $(".owl-carousel").trigger("refresh.owl.carousel"), jQuery(window).resize(function() {
    768 < jQuery(window).width() ? (p(), jQuery(".nav-main li a").not().hasClass("nav-main__link--arrow") && jQuery(".nav-main li").on("click", function() {
      var e = jQuery(this).find("a").attr("href");
      window.location.replace(e)
    }), $(".owl-carousel").trigger("refresh.owl.carousel")) : v(), $(".owl-carousel").trigger("refresh.owl.carousel")
  }), jQuery(document).on("input", "[id=meter-calculation]", function(e) {
    var a = jQuery(this).val();
    a = a.replace(/\,/g, ".").replace(/(\.)+?(.*)(\.)/, "$1$2").replace(/([^,.\d])|([,.](?=[,.]))|(^\D)/g, "").replace(/([,.]\d{2})(\d)/, "$1"), jQuery(this).val(a)
  }), jQuery(function(e) {
    e.mask.definitions.Z = "[1,2,3,4,5,6,9]", e('input[type="tel"]').mask("+7 (Z99) 999-99-99")
  }), $("#zvonok").each(function() {
    var e = $(this)
      , a = e.find('button[type="submit"]');
    e.find(".form-input").addClass("empty-field"), e.find(".empty-field").on("change", function() {
      "" != $(this).val() && $(this).removeClass("empty-field").removeClass("error")
    }), setInterval(function() {
      if (e.find(".form-input").each(function() {
          "" != $(this).val() ? $(this).removeClass("empty-field") : $(this).addClass("empty-field")
        }), 0 < e.find(".empty-field").size()) {
        if (a.hasClass("disabled")) return !1;
        a.addClass("disabled")
      } else a.removeClass("disabled")
    }, 1500), a.click(function() {
      if ($(this).hasClass("disabled")) return e.find(".empty-field").addClass("error"), !1;
      e.submit()
    })
    ...
    var e = $(this)
      , a = e.find('button[type="submit"]');
    e.find(".form-input").addClass("empty-field"), e.find(".selectric-wrapper").addClass("empty-field"), e.find(".empty-field").on("change", function() {
      "" != $(this).val() && $(this).removeClass("empty-field").removeClass("error")
    }), setInterval(function() {
      if (e.find(".form-input").each(function() {
          "" != $(this).val() ? $(this).removeClass("empty-field") : $(this).addClass("empty-field")
        }), e.find(".form-select").each(function() {
          "" != $(".form-select option:selected").val() ? $(this).removeClass("empty-field") : $(this).addClass("empty-field")
        }), 0 < e.find(".empty-field").size()) {
        if (a.hasClass("disabled")) return !1;
        a.addClass("disabled")
      } else a.removeClass("disabled")
  ...
  var T = {
      roomType1: [.06, .21, .32, 1]
      , roomType2: [.11, .21, .32, 1]
      , roomType3: [.05, .13, .15, 1]
      , roomType4: [.05, .13, .15, 1]
      , roomType5: [.05, .13, .15, 1]
      , roomType6: [.08, .19, .31, 1]
      , roomType7: [.07, .12, .18, .29]
    }
    , k = {
      roomType1: 4
      , roomType2: 4
    ...
    , f = {
      roomTypeFlat: [.2, .2, .2, .2, .2]
      , roomTypeRoom: [.5, .5, .5, .5, .5]
    }
    , y = {
      roomTypeFlat: [2, 2, 2, 2, 2]
      , roomTypeRoom: [1, 1, 2, 2, 2]
    }
    , D = {
      roomType1: [4, 8, 18, 1]
      , roomType2: [4, 7, 16, 1]
      ...
      , roomType4: [3, 14, 15, 1]
      , roomType5: [3, 14, 15, 1]
      , roomType6: [12, 25, 32, 1]
      , roomType7: [12, 16, 25, 32]
    }
    , 
    /*M = {
      roomType1: [2400, 3450, 5300, 1]
      , roomType2: [2790, 4150, 5960, 1]
      , roomType3: [11750, 29800, 34900, 1]
      , roomType4: [14500, 24200, 34800, 1]
      , roomType5: [11750, 29800, 34900, 1]
      , roomType6: [2790, 4150, 5960, 1]
      , roomType7: [2790, 4200, 5500, 6300]
    };*/

    M = {
      roomType1: [2395, 3445, 5295, 1]
      , roomType2: [2785, 4145, 5955, 1]
      , roomType3: [11745, 29795, 34895, 1]
      , roomType4: [14495, 24195, 34795, 1]
      , roomType5: [11745, 29795, 34895, 1]
      , roomType6: [2785, 4145, 5955, 1]
      , roomType7: [2785, 4195, 5495, 6295]
    };
  ...
  function I(e, a, t) {
    ...
    if (1 <= o) {
      var l, i, s = o - 1;
      l = e < 5 ? f.roomTypeRoom[a - 1] : f.roomTypeFlat[a - 1], s = Math.floor(s / l), i = e < 5 ? y.roomTypeRoom[a - 1] : y.roomTypeFlat[a - 1];
      var n = Math.floor(s * i);
      r += n;
      var u = "Стандартный метр:" + _["roomType" + e] + " больше стандарта в " + o;
      u = (u = u + " степ сайз " + l + " степ дэйс " + i) + " степ овер " + s + " дейc овер " + n
    }
    return r
  }
  ...
  function h(e) {
    if (1 == e) {
      var a = jQuery("#type-room option:selected").val()
        , t = k["roomType" + a]
        , r = jQuery("#type-remont-room option:selected").data("type-remont-room")
        , o = _["roomType" + a]
        , l = T["roomType" + a][r - 1]
        , i = D["roomType" + a][r - 1];
      jQuery(".tooltips-box").removeClass("active"), jQuery("#type-remont-room-" + r).addClass("active");
      var s, n = M["roomType" + a][r - 1];
      200 <= (u = jQuery("#enter-value-room").val()) ? (jQuery(".calculator-column--cost, .calculator-column--materials, .calculator-column--date").addClass("disabled"), jQuery(".calculator-value-error").addClass("active")) : (jQuery(".calculator-column--cost, .calculator-column--materials, .calculator-column--date").removeClass("disabled"), jQuery(".calculator-value-error").removeClass("active")), 1 == a ? (u = void 0 === u || u < 1 ? 10 : u, jQuery("#enter-value-room").prop("placeholder", "10")) : 2 == a ? (u = void 0 === u || u < 1 ? 6 : u, jQuery("#enter-value-room").prop("placeholder", "6")) : (u = void 0 === u || u < 1 ? 2 : u, jQuery("#enter-value-room").prop("placeholder", "2")), C = n * o, j = n * u, s = 0 == u.length ? C : Math.ceil(j), 5 == a ? i = Math.ceil(1.2 * i) : 4 == a && (t = Math.ceil(t / 2)), i += I(a, r, u), jQuery(".value").html(u), jQuery(".select-result").html(Math.ceil(s) + "  руб."), jQuery(".select-result-part").html(Math.ceil(s) + "  руб/мес."), jQuery(".select-materials").html(Math.ceil(s * l) + "  руб."), jQuery(".select-days").html(i + "  дн.");
      var u, d = jQuery("#type-room option:selected").text()
        , m = u = jQuery("#enter-value-room").val()
        , c = jQuery("#type-remont-room option:selected").text();
      jQuery('input[name="resultValRoomType"]').val(d), jQuery('input[name="resultValRoomMeter"]').val(m), jQuery('input[name="resultValRoomRemont"]').val(c), jQuery('input[name="resultValSum"]').val(s), jQuery('input[name="resultValDays"]').val(i)
    } else if (2 == e) {
      a = 6, t = k["roomType" + a], r = jQuery("#type-remont-apartment option:selected").data("type-remont-apartment"), l = T["roomType" + a][r - 1], i = D["roomType" + a][r - 1], o = _["roomType" + a];
      jQuery(".tooltips-box-apartment").removeClass("active"), jQuery("#type-remont-apartment-" + r).addClass("active");
      n = M["roomType" + a][r - 1];
      200 <= (y = jQuery("#enter-value").val()) ? (jQuery(".calculator-column--cost, .calculator-column--materials, .calculator-column--date").addClass("disabled"), jQuery(".calculator-value-error").addClass("active")) : (jQuery(".calculator-column--cost, .calculator-column--materials, .calculator-column--date").removeClass("disabled"), jQuery(".calculator-value-error").removeClass("active"));
      var p, v = jQuery('input[name="room"]:checked', "#rooms").val();
      C = n * v, j = n * y, 0 == y.length ? (jQuery("#enter-value").prop("placeholder", v), p = C) : p = Math.ceil(j), remontTypeDayFlat = Math.round(i * jQuery('input[name="room"]:checked', "#rooms").data("number-room")), remontTypeDayFlat += I(a, r, u), jQuery(".value").html(y), jQuery(".select-result").html(Math.ceil(p) + "  руб."), jQuery(".select-materials").html(Math.ceil(p * l) + "  руб."), jQuery(".select-days").html(remontTypeDayFlat + "  дн.");
      var f = jQuery('input[name="room"]:checked + label').html()
        , y = jQuery("#enter-value").val()
        , h = jQuery("#type-remont-apartment option:selected").text();
      remontTypeDayFlat;
      jQuery('input[name="resultValFlatType"]').val(f), jQuery('input[name="resultValFlatMeter"]').val(y), jQuery('input[name="resultValFlatRemont"]').val(h), jQuery('input[name="resultValSumFlat"]').val(p), jQuery('input[name="resultValDaysFlat"]').val(remontTypeDayFlat)
    } else if (3 == e) {
      a = 7, t = k["roomType" + a], r = jQuery("#type-finish option:selected").val(), l = T["roomType" + a][r - 1], i = D["roomType" + a][r - 1], o = _["roomType" + a], n = M["roomType" + a][r - 1];
      200 <= ($ = jQuery("#enter-value-new-room").val()) ? (jQuery(".calculator-column--cost, .calculator-column--materials, .calculator-column--date").addClass("disabled"), jQuery(".calculator-value-error").addClass("active")) : (jQuery(".calculator-column--cost, .calculator-column--materials, .calculator-column--date").removeClass("disabled"), jQuery(".calculator-value-error").removeClass("active"));
      var C, j, Q, b = jQuery('input[name="roomNew"]:checked', "#rooms-new").val();
      4 == r ? (jQuery('input[name="roomNew"]', "#rooms-new").prop("checked", !1), jQuery('input[id="room-new-1"]', "#rooms-new").prop("checked", !0), jQuery('input[name="roomNew"]+label', "#rooms-new").not(":first").addClass("unbind-hover")) : jQuery('input[name="roomNew"]+label', "#rooms-new").removeClass("unbind-hover"), C = n * b, j = n * $, 0 == $.length ? (jQuery("#enter-value-new-room").prop("placeholder", v), Q = C) : Q = Math.ceil(j), 4 == r && jQuery("#enter-value-new-room").prop("placeholder", "25"), remontTypeDayNew = Math.round(i * jQuery('input[name="roomNew"]:checked', "#rooms-new").data("number-room")), remontTypeDayNew += I(a, r, u), jQuery(".value").html($), jQuery(".select-result").html(Math.ceil(Q) + "  руб."), jQuery(".select-materials").html(Math.ceil(Q * l) + "  руб."), jQuery(".select-days").html(remontTypeDayNew + "  дн.");
      var g = jQuery('input[name="roomNew"]:checked + label').html()
        , $ = jQuery("#enter-value-new-room").val()
        , w = jQuery("#type-finish option:selected").text();
      remontTypeDayNew;
      jQuery('input[name="resultValNewType"]').val(g), jQuery('input[name="resultValNewMeter"]').val($), jQuery('input[name="resultValNewRemont"]').val(w), jQuery('input[name="resultValSumNew"]').val(Q), jQuery('input[name="resultValDaysNew"]').val(remontTypeDayNew)
    }
  }
  h(1), jQuery("#room select, #room input").on("change", function() {
    h(1)
  }), jQuery("#flat select, #flat input").on("change", function() {
    h(2)
  }), jQuery("#new-apartment input, #new-apartment select").on("change", function() {
    h(3)
  }), jQuery("#bath input, #bath select").on("change", function() {
    h(4)
  }), jQuery("#calculator__tab li").on("click", function(e) {
    e.preventDefault();
    var a = jQuery(this).data("step");
    jQuery("#calculator__tab li").removeClass("active"), jQuery('div[id^="step"]').removeClass("active"), jQuery('#calculator__tab li[data-step="' + a + '"]').addClass("active"), jQuery("#step-" + a).addClass("active"), h(a)
  }), jQuery("#calculator-submit-1").on("click", function() {
    var e = jQuery("#phone-calculator-1");
    if (0 == jQuery("#phone-calculator-1").val().length) return e.addClass("error"), !1;
    e.removeClass("error")
  }), jQuery("#calculator-submit-2").on("click", function() {
    var e = jQuery("#phone-calculator-2");
    if (0 == jQuery("#phone-calculator-2").val().length) return e.addClass("error"), !1;
    e.removeClass("error")
  }), jQuery("#calculator-submit-3").on("click", function() {
    var e = jQuery("#phone-calculator-3");
    if (0 == jQuery("#phone-calculator-3").val().length) return e.addClass("error"), !1;
    e.removeClass("error")
  }), jQuery(document).on("input", "[id=enter-value-room], [id=enter-value], [id=enter-value-new-room]", function(e) {
    var a = jQuery(this).val();
    a = a.replace(/\,/g, ".").replace(/(\.)+?(.*)(\.)/, "$1$2").replace(/([^,.\d])|([,.](?=[,.]))|(^\D)/g, "").replace(/([,.]\d{2})(\d)/, "$1"), jQuery(this).val(a)
  }), $(function() {
    $(document).on("click", ".benefit__arrow", function(e) {
      e.preventDefault();
      ...
      $(window).scroll(function() {
        ...
        e < t && t < a ? r.hasClass("active") || r.addClass("active") : r.removeClass("active")
      })
    })
  }), $(function() {
    var t = $(window)
      , r = $("#img").parent(".benefit__fixed__inside__images")
      , o = r.innerHeight() / 2;
    t.on("scroll", function() {
      var e = t.height() / 2
        , a = r.offset().top;
      $("body").toggleClass("scroll", t.scrollTop() + e - o >= a)
    })
  }), $(function() {
    var t = $(window)
      , r = $("#principlesImg").parent(".principles-circles__fixed__inside__images")
      , o = r.innerHeight() / 2;
    t.on("scroll", function() {
      var e = t.height() / 2
        , a = r.offset().top;
      $("body").toggleClass("principles-circles-scroll", t.scrollTop() + e - o >= a)
    })
  }), $(".image-popup").magnificPopup({
    type: "image"
  }), $(function() {
    $(".transform__img").each(function() {
      var e = $(this).offset().top;
      $(this).data("orig-offset", e)
    }), $(window).scroll(function() {
      var t = $(window).scrollTop();
      $(".transform__img").each(function() {
        var e = $(this).data("orig-offset");
        if (e <= t) {
          var a = (t - e) / $(window).height() * 250;
          $(this).css({
    ...
    , nav: !0
    , items: 1
  }), $(".our-masters__slider").owlCarousel({
    loop: !0
    , margin: 10
    , autoHeight: 0
    , nav: !0
    , items: 1
  }), $("#akcia-slider").owlCarousel({
    loop: !0
    , margin: 10
    , autoHeight: !0
    , nav: !0
  ...
  }), $(".certificates-popup").magnificPopup({
    delegate: "a"
    , type: "image"
    , tLoading: "Loading image #%curr%..."
    , mainClass: "mfp-img-mobile"
  ...
  }), $(".our-masters__popup").magnificPopup({
    delegate: "a"
    , type: "image"
    , tLoading: "Loading image #%curr%..."
    , mainClass: "mfp-img-mobile"
  ...
  $("#slider").owlCarousel({
    ...
    jQuery(".nav-toggle").hasClass("nav-toggle--opened") && (jQuery(".nav-button").removeClass("active"), jQuery(".nav-toggle").removeClass("nav-toggle--opened").addClass("nav-toggle--closed"), jQuery(".nav-wrapper").removeClass("nav-wrapper--opened").slideToggle("slow").addClass("nav-wrapper--closed"), jQuery(".nav-button").removeClass("active"), jQuery(".nav-overlay").removeClass("active"), document.onmousewheel = document.onwheel = function() {
      return !0
    }, document.onkeydown = function(e) {
      if (33 <= e.keyCode && e.keyCode <= 40) return !0
    }), e.preventDefault();
  ...
  $("input, select, textarea").bind("focus blur", function(e) {
    a.attr("content", "width=device-width,initial-scale=1,maximum-scale=" + ("blur" == e.type ? 10 : 1))
  }), $(function() {
    $(".youtube").each(function() {
      $(this).css("background-image", "url(https://i.ytimg.com/vi/" + this.id + "/hqdefault.jpg)"), $(this).append($("<div/>", {
        class: "play"
  ...
  }), owl = $(".owl-carousel"), owl.on("resized.owl.carousel", function(e) {
    var a = $(this);
    a.find(".owl-height").css("height", a.find(".owl-item.active").height())
  });
  var e = 0;
  if ($(".column").each(function() {
      $(this).height() > e && (e = $(this).height())
    }), $(".column").height(e), !!document.documentMode || /Edge\/\d./i.test(navigator.userAgent)) {
    var t = document.getElementsByTagName("head")[0]
      , r = document.createElement("link");
    r.rel = "stylesheet", r.href = "assets/css/ie.css", t.appendChild(r)
  }
});